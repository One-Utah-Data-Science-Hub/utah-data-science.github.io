...
## Forthcoming
* [Network of Genomic-Enabled Learning Health Systems (gLHS)](https://www.genome.gov/sites/default/files/media/files/2023-05/RFA_Concept_Clearance_Genomic_Enabled_Learning_Health_Systems.pdf)
* Supports a network of genomic-enabled learning health systems (gLHS) to identify and improve approaches for clinical integration of genomic information in a virtuous cycle of implementation, assessment, refinement, and reimplementation. Specifically, this initiative would: 1) support a coordinating center (CC) and 4-6 established or emerging gLHS clinical sites to share their genomic medicine implementation practices and identify those most suitable for cross-network implementation. 
* Deadline: TBD
* Award: Anticipated funds of $5.3M/year for 5 years.
